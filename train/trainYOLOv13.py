...
if __name__ == '__main__':
    ...
    model = YOLO("yolov13n.yaml").load("yolov13n.pt") 
    ...
    model.train(data=dataset_path, epochs=200, lr0=0.01, momentum=0.9, patience=40, optimizer="SGD", imgsz=640, batch=16, workers=4 , name="yolov13n_vnveggie")
