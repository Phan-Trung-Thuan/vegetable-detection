...
if __name__ == '__main__':
    ...
    model.train(data=dataset_path, epochs=200, lr0=0.005, momentum=0.9, patience=40, optimizer="AdamW", imgsz=640, batch=64, workers=4 , name="yolov10n_vnveggie", amp=False, device=[0, 1])
